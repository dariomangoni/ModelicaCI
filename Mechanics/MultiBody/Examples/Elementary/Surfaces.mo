...
model Surfaces
  ...
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation fixedTranslation1(r={0,-1.3,torus.ro + torus.ri},
      animation=false)
  ...
  Modelica.Mechanics.MultiBody.Visualizers.VoluminousWheel wheel
    annotation (Placement(transformation(extent={{30,50},{50,70}})));
  Modelica.Mechanics.MultiBody.Visualizers.PipeWithScalarField pipeWithScalarField(
    rOuter=0.3,
    length=1,
    T_min=0,
    T_max=2,
  ...
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation fixedTranslation3(
