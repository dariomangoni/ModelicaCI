...
model PointGravityWithPointMasses
  ...
  Modelica.Mechanics.MultiBody.Forces.Spring spring(showMass=false, c=10,
...
<p>
This model demonstrates the usage of model Modelica.Mechanics.MultiBody.Parts.PointMass in a
...
the used Modelica.Mechanics.MultiBody.Forces.LineForceWithMass component, then the orientation object
